...
/**
 * Stack implemented using an array of elements. Size of array (capacity) is
...
public class ArrayStack<T> implements Stack<T> {
	...
	/**
	 * Creates an empty stack. Initial capacity is {@code n} elements. Capacity is
	...
	/**
	 * Creates an empty stack with default initial capacity. Capacity is
	 * automatically increased when needed.
	 * <p>
	 * Time complexity: O(1)
	 */
	 ...
	 * {@inheritDoc}
	 * <p>
	 * Time complexity: mostly O(1). O(n) when stack capacity has to be increased.
	 */
